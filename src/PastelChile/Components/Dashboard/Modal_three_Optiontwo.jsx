...
function Modal_three_Optiontwo() {
  return (
    <Fragment>
        <div className="wrapper-modal">
            ...
            <div id="demo-modal-three" className="modal001">
                <div className="modal__content">
                    <h1>Eliminar pastelitos</h1>
                    <p>
                        ¿Estas seguro de borrar a "pastel"?
                        {/* Recordar que en las comillas va el nombre del pastel correspondiente al id */}
                    </p>
